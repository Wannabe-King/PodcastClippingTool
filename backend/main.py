...
def create_subtitles_with_ffmpeg(transcript_segments: list, clip_start: float, clip_end: float, clip_video_path: str, output_path: str, max_words: int = 5):
    ...
    # getting only the transcript segment which are present in the clip
    ...
    # processing the clip segment before burning it into the video
    for segment in clip_segments:
        ...
        # making subtitles relative to the clip instead of original video
    ...
    # combining the segments into a subtitle file
...
def process_clip(base_dir: str, original_video_path: str, s3_key: str, start_time: float, end_time: float, clip_index: int, transcript_segments: list):
    ...
    # creating and burning subtitle into the clip
    ...
    s3_client.upload_file(
        subtitle_output_path, "ai-podcast-clipper-tool-bucket", output_s3_key)
